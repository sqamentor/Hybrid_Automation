    ...
    def _load_project_urls(self):
        ...
        try:
            ...
            if config_path.exists():
                ...
                self.staging_url = 'projects.yaml not found'
                self.production_url = 'projects.yaml not found'
    ...
    def custom_run_mode(self):
        ...
        try:
            ...
            if self.yes_no("Generate HTML report?"):
                filename = input(f"{Colors.BOLD}Report filename (default=report.html): {Colors.ENDC}").strip()
                self.builder.add_html_report(filename if filename else "report.html")
    ...
    def scenario_based_mode(self):
        ...
        scenarios = {
            ...
            '5': {
                ...
                'desc': 'Headless, HTML report, all tests',
                'options': ['-v', '--html=test_report.html', '--self-contained-html']
            },
            '6': {
                'name': '🔧 CI/CD Pipeline',
