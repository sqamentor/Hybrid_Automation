...
class TestInsurancePageOnly:
    ...
    def test_insurance_member_name_valid(self, page: Page, smart_actions, fake_bookslot_data):
        """
        ...
        insurance_page = BookslotInsurancePage(
            page, navigator.multi_project_config["bookslot"]["ui_url"]
        )
    ...
    @pytest.mark.validation
    def test_group_number_optional(self, page: Page, smart_actions, fake_bookslot_data):
        """
...
class TestPersonalInfoPageOnly:
    ...
    @pytest.mark.validation
    def test_personal_info_address_field(self, page: Page, smart_actions, fake_bookslot_data):
        """
        ...
        with allure.step("Test address field"):
            ...
            personal_info_page = BookslotPersonalInfoPage(
                page, navigator.multi_project_config["bookslot"]["ui_url"]
            )
    ...
    @pytest.mark.validation
    def test_personal_info_dob_field(self, page: Page, smart_actions, fake_bookslot_data):
        """
...
class TestReferralPageOnly:
    ...
    def test_referral_source_options(
        ...
        referral_page = BookslotReferralPage(
            page, navigator.multi_project_config["bookslot"]["ui_url"]
        )
