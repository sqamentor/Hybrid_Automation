...
class TestPersonalInfoPage:
    ...
    def test_personal_info_page_loads(
    ...
    def test_dob_valid_formats(self, smart_actions, fake_bookslot_data, dob):
        ...
        act = smart_actions
        personal_page = BookslotPersonalInfoPage(
    ...
    def test_zip_code_validation(self, smart_actions, fake_bookslot_data, zip_code, is_valid):
        ...
        with allure.step(f"Test zip code: {zip_code} (Expected valid: {is_valid})"):
            ...
            if is_valid:
                ...
                ), f"Valid zip {zip_code} should allow progression"
            else:
                assert (
                    smart_actions.page.url == initial_url
                ), f"Invalid zip {zip_code} should prevent progression"
    ...
    def test_successful_submission(self, smart_actions, fake_bookslot_data, multi_project_config):
        ...
        with allure.step("Submit form"):
            ...
            assert (
                smart_actions.page.url != initial_url
            ), "Should proceed to next page with valid data"
            allure.attach(
                smart_actions.page.screenshot(full_page=True),
