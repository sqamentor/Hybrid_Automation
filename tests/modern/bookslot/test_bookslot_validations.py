...
class TestBasicInfoValidations:
    ...
    def test_basic_info_required_fields(self, page: Page, multi_project_config, smart_actions):
        """
...
class TestPersonalInfoValidations:
    ...
    @pytest.mark.parametrize(
        "dob",
        ["01/01/2000", "12/31/1990", "06/15/1985", "03/20/1995"],
    ...
    def test_date_of_birth_format_validation(
        ...
        with allure.step(f"Enter DOB: {dob}"):
            ...
            allure.attach(
                f"DOB: {dob}", name="dob_entered", attachment_type=allure.attachment_type.TEXT
            )
...
class TestInsuranceValidations:
    ...
    def test_insurance_group_number_optional(
        ...
        with allure.step("Submit insurance without group number"):
            ...
            allure.attach(
                "Group number optional validation passed",
