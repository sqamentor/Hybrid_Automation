...
class TestBookslotToPatientIntake:
    ...
    def test_book_appointment_and_verify_in_patientintake(
        self, test_context, bookslot_page, patientintake_page
    ):
        """
        ...
        bookslot_page.navigate().should_be_visible().fill_patient_info(
            appointment
        ).send_verification_code().should_show_verification_sent()
        ...
        patientintake_page.navigate().should_be_visible().search_appointment(
            appointment
        ...
        patientintake_page.verify_patient_name(appointment.first_name, appointment.last_name)
    ...
    def test_multiple_appointments_data_consistency(
        ...
        for appointment in appointments:
            ...
            bookslot_page.navigate().fill_patient_info(appointment).send_verification_code()
    ...
    @pytest.mark.human_like
    def test_appointment_with_full_details(self, test_context, bookslot_page, patientintake_page):
        """
        ...
        bookslot_page.navigate().fill_first_name(appointment.first_name).fill_last_name(
            appointment.last_name
        ).fill_email(appointment.email).fill_phone(appointment.phone).fill_zip_code(
            appointment.zip_code
        ).send_verification_code()

        # Verify in PatientIntake
        patientintake_page.navigate().search_by_email(appointment.email).should_show_appointment(
            appointment
        )
...
class TestCrossApplicationWorkflow:
    ...
    @pytest.mark.human_like
    def test_end_to_end_patient_journey(self, test_context, bookslot_page, patientintake_page):
        """
        ...
        bookslot_page.navigate().complete_form(appointment).should_show_verification_sent()

        # Staff searches for appointment in PatientIntake
        patientintake_page.navigate().search_by_name(
        ...
        details_page = PatientIntakeAppointmentDetailsPage(
            patientintake_page.page, patientintake_page.base_url
        )
