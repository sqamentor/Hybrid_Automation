...
class TestPluginHook:
    ...
    def test_hook_on_method(self):
        """Test hook decorator on method."""

        class MockPlugin(BasePlugin):
            def __init__(self):
                super().__init__(
                    PluginMetadata(name="test", version="1.0.0", author="Test", description="Test")
                )
...
class TestBasePlugin:
    ...
    def test_plugin_creation(self):
        ...
        metadata = PluginMetadata(
            name="test-plugin", version="1.0.0", author="Test", description="Test plugin"
        )
    ...
    def test_plugin_with_config(self):
        ...
        metadata = PluginMetadata(
            name="test-plugin", version="1.0.0", author="Test", description="Test"
        )
    ...
    def test_plugin_load_unload(self):
        ...
        metadata = PluginMetadata(name="test", version="1.0.0", author="Test", description="Test")
...
class TestPluginManager:
    ...
    async def test_hook_priority_ordering(self):
        ...
        manager.load_plugin_instance(
            MediumPriorityPlugin(PluginMetadata("medium", "1.0.0", "Test", "Test"))
        )
        manager.load_plugin_instance(
            LowPriorityPlugin(PluginMetadata("low", "1.0.0", "Test", "Test"))
        )
        manager.load_plugin_instance(
            HighPriorityPlugin(PluginMetadata("high", "1.0.0", "Test", "Test"))
        )
    ...
    def test_get_plugin_by_name(self):
        ...
        metadata = PluginMetadata(
            name="my-plugin", version="1.0.0", author="Test", description="Test"
        )
...
class TestPluginDependencies:
    ...
    def test_load_with_dependencies(self):
        ...
        metadata_a = PluginMetadata(
            name="plugin-a", version="1.0.0", author="Test", description="Test"
        )
...
class TestPluginDiscovery:
    ...
    def test_discover_plugins_from_directory(self, mock_import, mock_glob):
        ...
        # Mock plugin files
        mock_glob.return_value = [Path("plugins/test_plugin.py"), Path("plugins/another_plugin.py")]
...
class TestPluginErrors:
    ...
    def test_plugin_load_error(self):
        ...
        metadata = PluginMetadata(
            name="failing-plugin", version="1.0.0", author="Test", description="Test"
        )
    ...
    def test_duplicate_plugin_name(self):
        ...
        metadata = PluginMetadata(
            name="duplicate-name", version="1.0.0", author="Test", description="Test"
        )
