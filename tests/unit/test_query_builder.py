...
class TestQueryBuilder:
    ...
    def test_where_operators(self):
        ...
        builder = QueryBuilder()
        query, params = (
            builder.select("*").from_table("orders").where("total", 100, Operator.GT).build()
        )
        ...
        query, params = (
            builder.select("*")
            .from_table("users")
            .where("email", "%@test.com", Operator.LIKE)
            .build()
        )
    ...
    def test_where_in(self):
        ...
        builder = QueryBuilder()
        query, params = (
            builder.select("*").from_table("users").where("id", [1, 2, 3], Operator.IN).build()
        )
    ...
    def test_where_between(self):
        ...
        query, params = (
            builder.select("*")
            .from_table("orders")
            .where("created_at", ["2024-01-01", "2024-12-31"], Operator.BETWEEN)
            .build()
        )
    ...
    def test_order_by(self):
        ...
        builder = QueryBuilder()
        query, params = (
            builder.select("*").from_table("users").order_by("created_at", "DESC").build()
        )
    ...
    def test_limit(self):
        """Test LIMIT clause"""
        builder = QueryBuilder()
        query, params = builder.select("*").from_table("users").limit(10).build()
    ...
    def test_offset(self):
        """Test OFFSET clause"""
        builder = QueryBuilder()
        query, params = builder.select("*").from_table("users").limit(10).offset(20).build()
