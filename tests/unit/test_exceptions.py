...
class TestBaseException:
    ...
    def test_exception_with_details(self):
        ...
        exc = AutomationFrameworkException("Test error", details={"key": "value"})
    ...
    def test_exception_with_hint(self):
        ...
        exc = AutomationFrameworkException("Test error", hint="Try this solution")
        assert "Test error" in str(exc)
...
class TestAPIExceptions:
    ...
    def test_api_validation_exception(self):
        ...
        exc = APIValidationException("/api/users", "status_code", expected=200, actual=404)
        assert "/api/users" in str(exc)
...
class TestDatabaseExceptions:
    ...
    def test_database_validation_exception(self):
        ...
        exc = DatabaseValidationException(
            "row_count", expected=10, actual=5, query="SELECT COUNT(*) FROM orders"
        )
