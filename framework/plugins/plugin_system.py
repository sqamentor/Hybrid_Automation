...
Extensible plugin system for framework extensibility and customization. Supports dynamic plugin
loading, lifecycle management, and dependency resolution.
"""
...
class PluginHookData:
    ...
    priority: PluginPriority | int = PluginPriority.NORMAL
    plugin_name: str = ""
...
def PluginHook(
    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
        callback = cast(Any, func)
        callback._hook_name = name
        callback._hook_priority = priority
        callback._hook_description = description
...
class PluginManager:
    ...
    async def execute_hooks(self, hook_name: str, *args: Any, **kwargs: Any) -> List[Any]:
        """Execute all registered hooks for a hook point. Hooks are executed in priority order
        ...
        def get_priority_value(h: PluginHookData) -> int:
