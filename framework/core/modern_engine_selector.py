...
class ModernEngineSelector:
    ...
    def __init__(
        ...
        self._cache_stats = {"hits": 0, "misses": 0, "total_lookups": 0}
    ...
    def select_engine(self, metadata: TestMetadata) -> EngineDecision:
        ...
        match (metadata.ui_framework, metadata.complexity, metadata.legacy_system):
            ...
            case (
                UIFramework.REACT | UIFramework.VUE | UIFramework.ANGULAR,
                TestComplexity.SIMPLE | TestComplexity.MODERATE,
                False,
            ):
            ...
            case (
                UIFramework.REACT | UIFramework.VUE | UIFramework.ANGULAR,
                TestComplexity.COMPLEX | TestComplexity.VERY_COMPLEX,
                False,
            ):
                return EngineDecision(
