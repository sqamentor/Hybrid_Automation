...
class AsyncSmartActions:
    ...
    async def _human_delay_after(self, action_type: str) -> None:
        """Add context-aware delay after action"""
        ...
        min_delay, max_delay = delay_ranges.get(action_type, (self.min_delay_ms, self.max_delay_ms))
...
class AsyncPageFactory:
    ...
    def __init__(self, browser=None, viewport: Optional[dict] = None, **context_options):
        self._playwright = None
        self._browser = browser  # Accept external browser instance
        self._context = None
