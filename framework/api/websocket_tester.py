...
class WebSocketTester:
    ...
    async def _listen(self):
        ...
        try:
            async for message in self.connection:
                ...
                message_obj = {"timestamp": timestamp, "data": data, "raw": message}
    ...
    def wait_for_message(
        self, timeout: float = 10, condition: Optional[Callable] = None
    ) -> Optional[Dict]:
        """
...
class SyncWebSocketTester:
    ...
    def send_message(self, message: Any):
        ...
        future = asyncio.run_coroutine_threadsafe(self.tester.send_message(message), self.loop)
